...
import copy
from .backbones.vit_pytorch_mbf import vit_base_patch16_224_TransReID, vit_small_patch16_224_TransReID, deit_small_patch16_224_TransReID, vit_base_patch16_224_MBF
...
class build_transformer_local(nn.Module):
    ...
    def forward(self, x, label=None, cam_label= None, view_label=None, keep_rate=None, get_idx=False, f_size=(16, 8), is_occ=True):
        ...
        ### 3. Global-Local feature Extractor
        ...
        patches = patches.permute(1, 0, 2, 3)                   # [B, K, P, C] -> [K, B, P, D]
        ...
        if is_occ:
            ...
            with torch.no_grad():
                ...
                de_patch_cls_scores = F.softmax(de_patch_cls_scores, dim=1)     # [B, K+1, fH, fW]
                ...
                de_patches = de_patches.permute(1, 0, 2, 3)                     # [B, K, P, C] -> [K, B, P, D]
                de_token = token
        ...
        if self.training:
            ...
            if is_occ:
                ...
                ], de_feat_bn, patch_cls_scores, idx, loss_orth, de_patch
            else:
                return [cls_score, cls_score_1, cls_score_2, cls_score_3, cls_score_4
                ], en_feat_bn, patch_cls_scores, idx, loss_orth, feat_patch
