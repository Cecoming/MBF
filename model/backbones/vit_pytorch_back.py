...
class TransReID(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, local_feature=False, sie_xishu =1.0, inner_sub=False):
        # inner_sub=True is added
        super().__init__()
        ...
        self.back_token = nn.Parameter(torch.zeros(1, 1, embed_dim))
    ...
    def no_weight_decay(self):
        return {'pos_embed', 'cls_token', 'back_token'}
    ...
    def forward_features(self, x, camera_id, view_id):
        ...
        back_tokens = self.back_token.expand(B, -1, -1)
        x = torch.cat((cls_tokens, back_tokens, x), dim=1)
    ...
    def load_param(self, model_path):
        ...
        for k, v in param_dict.items():
            ...
            if 'patch_embed.proj.weight' in k and len(v.shape) < 4:
                ...
                v = resize_pos_embed(v, self.pos_embed, self.patch_embed.num_y, self.patch_embed.num_x, 2)
            try:
