...
python -m torch.distributed.launch --nproc_per_node=2 --master_port 8888 train.py --config_file configs/OCC_Duke/vit_transreid_stride.yml MODEL.DIST_TRAIN True